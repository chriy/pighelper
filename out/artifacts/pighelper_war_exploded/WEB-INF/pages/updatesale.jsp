    ...
    <form method="post" class="layui-form layui-form-pane submit">
        <div class="layui-container">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    ...
                    <input type="text" name="saleDate" value="${sale.saleDate }" id="saleDate" class="layui-input" readonly="readonly" autocomplete="off" placeholder="请选择日期" lay-verify="saleDate" lay-verType="msg"/>
                </div>
            </div>
        </div><br>
        <div class="layui-container">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="saleQuantity" value="${sale.saleQuantity }" class="layui-input" autocomplete="off" placeholder="请输入数量" required lay-verify="saleQuantity|required|number" lay-verType="msg"/>
                </div>
            </div>
        </div><br>
        <div class="layui-container">
        ...
        <div class="layui-container">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="saleVariety" value="${sale.saleVariety }" class="layui-input" autocomplete="off" placeholder="请输入卖出品种" required lay-verify="saleVariety|required" lay-verType="msg"/>
                </div>
            </div>
        </div><br>
        <div class="layui-container">
        ...
        <div class="layui-btn-container layui-container" style="margin-top: 40px;">
            ...
            <button class="layui-btn layui-btn-radius layui-btn-lg layui-bg-liner layui-btn-fluid" lay-submit lay-filter="updateother">立即修改</button>
        </div>
    </form>
</section>
...
<script type="text/javascript">
    layui.use(['element','laydate','form','layer'], function() {
        ...
        form.on("submit(updateother)",function (data) {
            $.post("updatesale",data.field,function (result) {
                if(result == "OK"){
                    $("form")[0].reset();
