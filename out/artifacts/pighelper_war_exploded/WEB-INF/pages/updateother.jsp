    ...
    <form action="" class="layui-form layui-form-pane submit">
        <div class="layui-container">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="hidden" name="recordID" value="${other.recordID }"/>
                    <input type="text" name="recordDate" value="${other.recordDate }" id="recordDate"
                           class="layui-input" readonly="readonly" autocomplete="off" placeholder="请选择日期"
                           lay-verify="recordDate" lay-verType="msg"/>
                </div>
            </div>
        </div>
        <br/>
        <div class="layui-container">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="recordDetails" value="${other.recordDetails }" class="layui-input"
                           autocomplete="off" placeholder="请输入详细记录" required lay-verify="recordDetails|required"
                           lay-verType="msg"/>
                </div>
            </div>
        </div>
        ...
        <div class="layui-container">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="recordMoney" value="${other.recordMoney }" class="layui-input"
                           autocomplete="off" placeholder="请输入总数" required lay-verify="recordMoney"
                           lay-verType="msg"/>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    layui.use(['element', 'laydate', 'form', 'layer'], function () {
        ...
        form.on("submit(updateother)", function (data) {
            $.post("updateother", data.field, function (result) {
                if (result == "OK") {
                    $("form")[0].reset();
